  ...
  return (
    <main>
      ...
      <Routes>
        ...
        <Route path="/login" element={<Login setCustAddresses={setCustAddresses} setCustProducts={setCustProducts} setProductCount={setProductCount} getProducts={getProducts} getCustomers={getCustomers} getAddresses={getAddresses} getCustomizations={getCustomizations} getOrders={getOrders}/>} />
        ...
        {currentCustomer.admin ? <Route path="/all-orders" element={<AllOrders orders={orders} setOrders={setOrders}/>} /> : null}
